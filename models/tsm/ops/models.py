...
class TSN(nn.Module):
    def __init__(self, num_segments, modality,
                 ...
                 crop_num=1, partial_bn=True, print_spec=True, pretrain=None,
    ...
    def _prepare_base_model(self, base_model):
        ...
        if 'resnet' in base_model:
            ...
            self.base_model = resnet50(pretrain=self.pretrain, truncate=True)
            ...
            self.base_model = bninception(pretrain=self.pretrain)
